const Home = () => {
    return (
      <div>
        <h1>SisPB: Sistema de Prestamos Bancarios</h1>
        <p>
          SisPB es una aplicación web para gestionar las solicitudes de
          prestamos de los clientes. Esta aplicación ha sido desarrollada 
